...
#include "jugador.h"
	...
	después el nombre de cada uno. A todos se les asigna el pozo inicial de 2000
	...
	*/
	...
	void cargarJugadores(Jugador jugadores[], int &cant){
		...
		recién en el momento de la liquidación del giro.
		*/
		...
		- Numero resultado: Número que salió en el giro de la ruleta.
		
		Retorna: 
		- int: Cantidad de fichas que corresponde devolver al jugador (0 si perdió).
		
		Descripción:
		Compara la apuesta contra el resultado obtenido y calcula el pago según las 
		tasas indicadas por la cátedra: número exacto paga36 a 1, color o paridad
		...
		*/
		...
		/*
		Función: liquidarApuestas
		
		Parámetros: 
		- Jugador jugadores[]: Arreglo con los jugadores de la sesión.
		- int cant: Cantidad de jugadores activos.
		- Numero resultado: Número obtenido en el giro que se está liquidando.
		
		Retorna:
		- void: No retorna ningún valor.
		
		Descripción:
		Recorre la última apuesta cargada de cada jugador, calcula el pago que le
		corresponde contra el resultado del giro, acreita las fichas ganadas y
		actualiza los contadores de victorias y derrotas según corresponda.
		*/
		...
		*/
		...
		Retorna: 
		- bool: true si algún jugador se quedó con 0 fichas; false en caso contrario.
		
		Descripción:
		Recorre el arreglo de jugadores buscando si alguno agoto por completo su
		saldo de fichas, condición que obliga a finalizar la sesión en curso.
		*/
